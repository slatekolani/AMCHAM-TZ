...
type OurWorkEditProps = PageProps<{ item: OurWorkItem | null }>;

export default function OurWorkEdit({ item }: OurWorkEditProps) {
    ...
    const submit = (event: FormEvent) => {
        ...
        post(item ? route('admin.our-work.update', item.uuid) : route('admin.our-work.store'), { forceFormData: true });
    };
        ...
        <AdminLayout
            header={
                <div>
                    ...
                    <h1 className="mt-2 text-3xl font-display font-semibold text-[#14234a]">{item ? 'Edit work item' : 'New work item'}</h1>
                </div>
            }
        >
            <Head title="Admin — Edit work item" />
            ...
            <form onSubmit={submit} className="grid max-w-4xl gap-5">
                ...
                <label className="grid gap-2 text-sm font-bold text-[#14234a]">
                    Summary
                    <span className="text-xs font-normal text-[#667085]">Short line shown in the "Our Work" navigation dropdown.</span>
                ...
                <label className="grid gap-2 text-sm font-bold text-[#14234a]">
                    Body
                    <span className="text-xs font-normal text-[#667085]">Full content shown on this item's own public page.</span>
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                    ...
                    <label className="flex items-center gap-3 self-end pb-3 text-sm font-bold text-[#14234a]">
                        ...
                        Published — visible in the Our Work navigation and on the public site
                    </label>
                </div>
